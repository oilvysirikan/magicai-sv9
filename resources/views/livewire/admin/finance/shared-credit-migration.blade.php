<div class="flex">
    ...
    <div class="mx-auto w-full py-10 lg:w-2/3">
        <x-alert
            ...
            variant="warn-fill"
        >
            @lang('This wizard helps you migrate existing plans and their users from the separated credit system to shared credits. Please review each step carefully before executing.')
        </x-alert>
        ...
        @includeWhen($this->currentStepIs(1), 'panel.admin.finance.credit-migration.step-1-analysis')
        @includeWhen($this->currentStepIs(2), 'panel.admin.finance.credit-migration.step-2-configure')
        @includeWhen($this->currentStepIs(3), 'panel.admin.finance.credit-migration.step-3-users')
        @includeWhen($this->currentStepIs(4), 'panel.admin.finance.credit-migration.step-4-execute')
        @includeWhen($this->currentStepIs(5), 'panel.admin.finance.credit-migration.step-5-notification')

        @include('panel.admin.finance.credit-migration.step-actions')
    </div>
</div>
