...
class MenuService
{
    ...
    public function data(): array
    {
        ...
        $menu = [
            ...
            'ext_crm_dropdown' => [
                ...
                'route'            => 'dashboard.user.crm.index',
                'label'            => 'CRM',
                ...
                'show_condition' => MarketplaceHelper::isRegistered('crm') && (bool) setting('crm_enabled', '1'),
            ],
            'crm_dashboard' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_dashboard',
                'route'            => 'dashboard.user.crm.index',
                'label'            => 'Dashboard',
                ...
                'show_condition' => MarketplaceHelper::isRegistered('crm'),
            ],
			'crm_assistant' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_assistant',
                'route'            => 'dashboard.user.crm.ai.index',
                'label'            => 'CRM Assistant',
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.user.crm.ai.*',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('crm') && (bool) setting('crm_assistant_enabled', '1'),
            ],
            'crm_contacts' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_contacts',
                'route'            => 'dashboard.user.crm.contacts.index',
                'label'            => 'Contacts',
            ...
            'crm_deals' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_deals',
                'route'            => 'dashboard.user.crm.deals.index',
                'label'            => 'Deals',
                'icon'             => 'tabler-coin',
                'svg'              => null,
                'order'            => 5,
            ...
            'crm_projects' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_projects',
                'route'            => 'dashboard.user.crm.projects.index',
                'label'            => 'Projects',
                'icon'             => 'tabler-briefcase',
                'svg'              => null,
                'order'            => 6,
            ...
            'crm_tasks' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_tasks',
                'route'            => 'dashboard.user.crm.tasks.index',
                'label'            => 'Tasks',
            ...
            'crm_calendar' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_calendar',
                'route'            => 'dashboard.user.crm.calendar.index',
                'label'            => 'Calendar',
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.user.crm.calendar.*',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('crm'),
            ],
            'crm_presentations' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_presentations',
                'route'            => 'dashboard.user.crm.presentations.index',
                'label'            => 'Presentations',
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.user.crm.presentations.*',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('crm') && (bool) setting('crm_presentations_enabled', '1'),
            ],
            'crm_reports' => [
                'parent_key'       => 'ext_crm_dropdown',
                'key'              => 'crm_reports',
                'route'            => 'dashboard.user.crm.reports.index',
                'label'            => 'Reports',
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.user.crm.reports.*',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('crm'),
            ],
            'ext_sales_dropdown' => [
                'parent_key'       => null,
                'key'              => 'ext_sales_dropdown',
                'route'            => 'dashboard.user.sales.invoices.index',
                'label'            => 'Sales',
                'icon'             => 'tabler-receipt',
                'svg'              => null,
                'order'            => 5,
            ...
            'crm_sales_invoices' => [
                'parent_key'       => 'ext_sales_dropdown',
                'key'              => 'crm_sales_invoices',
                'route'            => 'dashboard.user.sales.invoices.index',
                'label'            => 'Invoices',
            ...
            'crm_sales_payments' => [
                'parent_key'       => 'ext_sales_dropdown',
                'key'              => 'crm_sales_payments',
                'route'            => 'dashboard.user.sales.payments.index',
                'label'            => 'Payments',
                'icon'             => 'tabler-cash',
                'svg'              => null,
                'order'            => 2,
            ...
            'crm_sales_proposals' => [
                'parent_key'       => 'ext_sales_dropdown',
                'key'              => 'crm_sales_proposals',
                'route'            => 'dashboard.user.sales.proposals.index',
                'label'            => 'Proposals',
            ...
            'crm_sales_estimates' => [
                'parent_key'       => 'ext_sales_dropdown',
                'key'              => 'crm_sales_estimates',
                'route'            => 'dashboard.user.sales.estimates.index',
                'label'            => 'Estimates',
    ...
    public static function planAiToolsMenu(): array
    {
        ...
        if (MarketplaceHelper::isRegistered('crm')) {
            $result[] = [
                'key'     => 'ext_crm_dropdown',
                'label'   => __('CRM'),
                'tooltip' => __('Allow users on this plan to use the CRM (contacts, companies, deals, projects, tasks, calendar, presentations, and AI assistant).'),
                'icon'    => 'tabler-briefcase',
            ];
            ...
            $result[] = [
                'key'     => 'ext_sales_dropdown',
                'label'   => __('Sales'),
                'tooltip' => __('Allow users on this plan to use Sales (invoices, payments, proposals, and estimates).'),
                'icon'    => 'tabler-file-invoice',
            ];
        }
