...
class VideoBackgroundRemovalDriver extends BaseDriver implements WithInputVideoInterface, WithVideoToVideoInterface
{
    use HasInputVideo;
    use HasVideoToVideo;
    ...
    {
        return EntityEnum::VIDEO_BACKGROUND_REMOVAL;
    }
}
