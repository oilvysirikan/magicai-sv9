...
<body class="overflow-x-hidden bg-white font-body font-normal text-[#272D38] antialiased">
    <div class="container py-24">
        <div class="text-center">
            ...
            @if (session('message') || session()->has('errors'))
                <div class="relative mx-auto w-full max-w-4xl px-10 text-start">
                    <div class="mb-8 mt-3 flex flex-col">
                        ...
                        @if (session()->has('errors'))
                            ...
                            >
                                <button
                                    class="close absolute -end-4 -top-4 flex size-8 items-center justify-center rounded-full bg-red-900 text-white"
                                    id="close_alert"
                                    data-dismiss="alert"
                                    type="button"
                                    aria-hidden="true"
    ...
    <div class="fixed bottom-10 end-10">
        <a
            class="inline-flex size-10 items-center justify-center rounded-full border border-black border-opacity-10 transition-all hover:border-black hover:bg-black hover:text-white"
            target="_blank"
